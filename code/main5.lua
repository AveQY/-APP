...
if parameter=="视频模板" then
 ...
 elseif parameter=="工具模板+网抑云"
  ...
  ed6.setVisibility(View.GONE)
  高级设置.setText("高级设置(只对自动执行事件有效)")
 elseif parameter=="网页模板"
  set1.setVisibility(View.GONE)
  ed4.setVisibility(View.GONE)
  set2.setVisibility(View.GONE)
  ed7.setVisibility(View.VISIBLE)
  高级设置.setText("高级设置(只对自动执行事件有效)")
 elseif parameter=="游戏模板+井字棋" or "游戏模板+五子棋"
  set1.setVisibility(View.GONE)
  ed4.setVisibility(View.GONE)
  set2.setVisibility(View.GONE)
  ed6.setVisibility(View.GONE)
...
btn.onClick=function()
  ...
  if parameter=="网页模板" then
    ...
    if 浏览器缩放.Checked==true
      io.open("/sdcard/訫/MyApp/main.lua","a+"):write("\nweb.getSettings().setDisplayZoomControls(false) web.requestFocusFromTouch() web.getSettings().setSupportZoom(true) "):close()
    end
  end
...
choose_video.onClick=function()
  Toast.makeText(activity,"请选择视频", Toast.LENGTH_LONG).show()
  调用系统选择文件(function (a)
...
choose_music.onClick=function()
  Toast.makeText(activity,"请选择音乐", Toast.LENGTH_LONG).show()
  调用系统选择文件(function (a)
    LuaUtil.copyDir(a,主路径.."/MyApp/music/"..tonumber(i+1)..".mp3")
    i=i+1
    mu.setText(mu.Text.."/"..i..".mp3\n")
  end)
end